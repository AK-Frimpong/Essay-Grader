    ...
    >
      <div className="glass-panel relative w-full max-w-md bg-white dark:bg-gh-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="p-6 text-center space-y-5">
          ...
          {/* LAN URL Box */}
          <div className="flex items-center justify-between px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-gh-slate-950 border border-slate-200 dark:border-slate-800">
            <span className="font-mono text-sm text-emerald-700 dark:text-gh-emerald-400 font-bold truncate">
              {lanUrl}
            </span>
            <button
              onClick={copyUrl}
          ...
          <div className="flex items-center justify-center gap-4 text-xs text-slate-500 dark:text-slate-400 pt-1">
            <div className="flex items-center gap-1.5">
              <Wifi className="w-4 h-4 text-emerald-600 dark:text-gh-emerald-400" />
              <span>Zero Internet / 100% Offline</span>
            </div>
            <div className="flex items-center gap-1.5">
              <Smartphone className="w-4 h-4 text-amber-600 dark:text-gh-gold-400" />
